    ...
    <div className="bg-white pb-12">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 mb-6">
          ...
          already built in. These will be included and expanded when the full app launches.
        </p>
        ...
        <div className="bg-white border rounded-xl shadow-sm p-8 text-center">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
            ...
            <button
              ...
              className="px-6 py-3 bg-blue-600 text-white font-medium rounded-md hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed hover:cursor-pointer"
            >
